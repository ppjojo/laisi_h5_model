        ...
        <div class="teamDetailContain">
            <div class="teamInfoBox">
                <div class="activeTeam">
                    ...
                    <div v-if="competitionItem.mode==2"> 总个数：<span
                            class="bigNumberSpan">{{teamList[0].totalBestValue||'--'}}</span>个</div>
                    <div v-else> 总时长：
                ...
                <div class="powerTeam">
                    ...
                    <div v-if="competitionItem.mode==2"> 总个数：<span
                            class="bigNumberSpan">{{teamList[1].totalBestValue||'--'}}</span>个</div>
                    <div v-else> 总时长：
                        ...
                        <div class="leftRightBox">
                            <div class="left">
                                <div v-if="teamList[0].dataDetail.length>0">
                                    <div class="listItem" v-for="item in teamList[0].dataDetail"
                                        :class="currentUserId==item.userId?'self':''"
                                        ...
                                        <div class="scoreBox">
                                            ...
                                            <div v-if="competitionItem.mode==2">个数：<span
                                                    class="bigNumberSpan">{{item.bestValue||'--'}}</span>个</div>
                                            <div v-else>时长：
                            ...
                            <div class="right">
                                <div v-if="teamList[1].dataDetail.length>0">
                                    <div class="listItem" :class="currentUserId==item.userId?'self':''"
                                        v-for="item in teamList[1].dataDetail"
                                        @click="$interaction.visitPersonalHomepage(item.userId)">
                                        <div class="border" style="width:2px"></div>
                                        <img class="headerPic" :src="item.headerPicUrl" alt="">
                                        <div class="scoreBox">
            ...
            detailInitData() {
                detailInfo({
                    ...
                    if (res.code == 0) {
                        ...
                        var maxNum = rows[0].totalAttend;
                        if (rows[0].totalAttend < rows[1].totalAttend) {
                            maxNum = rows[1].totalAttend
                        }
                        ...
                        if (this.page == 0) {
                            ...
                            this.teamList[0].dataDetail = this.teamList[0].dataDetail.concat(rows[0]
                                .dataDetail);
                            this.teamList[1].dataDetail = this.teamList[1].dataDetail.concat(rows[1]
                                .dataDetail)
                        }
                    }
                    setTimeout(()=>{
