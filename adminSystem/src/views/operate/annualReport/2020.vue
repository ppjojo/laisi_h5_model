<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
            ...
            <el-table-column align="center" label="操作" width="180">
                <template scope="scope">
                    ...
                    <el-button @click="btn_addRed(scope.row)" type="text" size="mini" style="color:#67c23a"
                        v-if="checkPer('addRedpacket')">添加红包
                    </el-button>
                    <el-button @click="btn_redStatus(scope.row)" type="text" size="mini" style="color:#67c23a"
                        v-if="checkPer('addRedpacket')">红包状态
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :title="this.form.name+'的红包详情'" :visible.sync="detailDialogVisible" width="60%">
            ...
            <el-table v-loading="loading" :data="packetList" element-loading-text="Loading" border fit highlight-current-row
                size="small " >
...
<script>
    ...
    import { listItem, addItem, updateItem, addRedItem, redPacketStatus } from '@/api/operate/annualReport/2020'
