<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
            size="small ">
            <el-table-column align="center" prop="coinCount" label="日期">
                <template scope="scope">
                  {{scope.row.checkTime | formatDate}}
                </template>
            </el-table-column>
            <el-table-column align="center" prop="count" label="今日领取人数">
            </el-table-column>
            <el-table-column align="center" prop="newAttendCount" label="新增参与人数">
            </el-table-column>
        </el-table>
...
<script>
    import { listItem } from '@/api/operate/pointLottery/coinsReport'
