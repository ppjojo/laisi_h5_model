<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
            size="small ">
            <el-table-column align="center" label="血氧时间点">
                <template slot-scope="scope">
                    {{ scope.row.startStamp |  formatDate}}</span>
                </template>
            </el-table-column>
			<el-table-column align="center" prop="maxBloodOxygen" label="最高血氧值">
			</el-table-column>
			<el-table-column align="center" prop="minBloodOxygen" label="最低血氧值">
			</el-table-column>
...
<script>
    import { memberList, oxygenSearch,MacList } from '@/api/dataSearch/dataSearch'
