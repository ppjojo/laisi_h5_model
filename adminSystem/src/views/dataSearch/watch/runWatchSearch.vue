            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <div v-if="props.row.cardType.indexOf('air') != -1">
                        <el-table :data="props.row.data" style="width: 100%">
                    ...
                    <div v-else-if="props.row.cardType.indexOf('balance') != -1">
                        <el-table :data="props.row.data" style="width: 100%">
                            <el-table-column prop="claimDataNumber" label="claimDataNumber">
                            </el-table-column>
                        </el-table>
                    </div>
...
<script>
    import { memberList, watchGetHistory,MacList } from '@/api/dataSearch/dataSearch'
