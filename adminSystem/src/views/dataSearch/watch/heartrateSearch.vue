<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
			...
			<el-table-column align="center" prop="totalSteps" label="总步数">
			</el-table-column>
			<el-table-column align="center" prop="totalDistance" label="总距离">
			</el-table-column>
...
<script>
    import { memberList, heartrateSearch,MacList } from '@/api/dataSearch/dataSearch'
