<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
			...
			<el-table-column align="center" prop="daySteps" label="日步数">
			</el-table-column>
			<el-table-column align="center" prop="dayDistance" label="日距离">
			</el-table-column>
			<el-table-column align="center" prop="daySportCalory" label="日运动消耗卡路里">
			</el-table-column>
			<el-table-column align="center" prop="dayBasicCalory" label="日基础消耗卡路里">
			</el-table-column>
			<el-table-column align="center" prop="sedentaryCount" label="停下次数">
			</el-table-column>
			<el-table-column align="center" prop="targetSteps" label="目标步数">
			</el-table-column>
			<el-table-column align="center" prop="targetComplete" label="目标完成次数">
			</el-table-column>
...
<script>
    import { memberList, backgroundStepSearch } from '@/api/dataSearch/dataSearch'
    ...
    export default {
        ...
        methods: {
            ...
            searchData() {
                ...
                backgroundStepSearch(para).then(res => {
                    this.loading = false;
                    if (!res.data) return;
