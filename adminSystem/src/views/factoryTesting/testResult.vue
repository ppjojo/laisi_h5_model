            ...
            <el-form :inline="true" :model="searchForm">
                ...
                <el-form-item label="所属测试项">
                    <el-select v-model="searchForm.testItemId" placeholder="全部" clearable>
                        <el-option v-for="item in testItemList" :key="item.id" :label="item.testItemName"
                            :value="item.id"></el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="测试时间">
                    <el-date-picker v-model="searchForm.timestamp" type="date" value-format='timestamp'
                        placeholder="选择日期">
                    </el-date-picker>
                </el-form-item>
...
<script>
    import { listItem } from '@/api/factoryTesting/testResult'
