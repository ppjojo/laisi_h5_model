    ...
    <el-dialog :title="dialogTitle+'配置项'" :visible.sync="dialogVisible" width="50%">
      <el-form :model="form" label-width="100px" :rules="rules" ref="form">
        ...
        <el-form-item label="测试项" prop="testItemIdList">
          ...
          <el-button v-if=" !(form.testItemList && form.testItemList.length)" icon="el-icon-plus" size='small' circle
            @click="addTestItem"></el-button>
...
<script>
  ...
  import {
    listItem2 as projectListItem
  } from '@/api/factoryTesting/project'
  import {
    listItem as testItemListItem
  } from '@/api/factoryTesting/testItem'
  import {
    listItem2 as testTypeListItem
  } from '@/api/factoryTesting/testType'
  import {
    listItem as station
  } from '@/api/factoryTesting/station'
