<template>
    <div class="app-container">
        <div class="container-edit">
            <el-button type="primary" size="mini" @click="btn_add()" >添加站位</el-button>
        </div>
        <el-table v-loading="loading" :data="list" element-loading-text="Loading" border fit highlight-current-row
            size="small ">
            <el-table-column align="center" prop="id" label="ID" width="65"></el-table-column>
            <el-table-column align="center" prop="stationName" label="站位名称">
            </el-table-column>
        ...
        <!--新增和编辑界面-->
        <el-dialog :title="dialogTitle+'站位'" :visible.sync="dialogVisible" width="50%">
            <el-form :model="form" label-width="100px" :rules="rules" ref="form">
                <el-form-item label="站位名" >
                    <el-input v-model="form.stationName"></el-input>
                  </el-form-item>
                  <el-form-item label="站位状态">
...
<script>
    import { listItem, addItem, updateItem, deleteItem } from '@/api/factoryTesting/station'
    ...
    export default {
        ...
        methods: {
                    ...
                    if (valid) {
                        ...
                        if (this.dialogTitle == "新增") {
                            addItem(this.form).then(response => {
                                ...
                                this.$notify({
                                    type: 'success',
                                    message: '成功新增' + this.form.stationName 
                                });
                            })
                        } else {
                            updateItem(this.form).then(response => {
                                ...
                                this.$notify({
                                    type: 'success',
                                    message: '成功修改' + this.form.stationName 
                                });
                            })
                        }
                    } else {
            ...
            //删除
            btn_delete(id) {
                this.$confirm('此操作将永久删除站位, 是否继续?', '提示', {
