<template>
  <div class="app-container">
    <div class="container-edit">
      <el-upload ref='upload' action="" :http-request="submitUser" :show-file-list="false">
        <el-button type="primary" size="mini">导入京东用户</el-button>
      </el-upload>
    ...
    <el-dialog :title="dialogTitle+'比赛'" :visible.sync="dialogVisible" width="50%">
      <el-form :model="form" label-width="120px" :rules="rules" ref="form">
        ...
        <!-- <el-form-item label="奖励">
          <el-input v-model="form.gameReward" placeholder=""> </el-input>
        </el-form-item> -->
      </el-form>
    ...
    <el-dialog title="excel异常显示" :visible.sync="errorVisible" width="50%">
      <el-table :data="errorList" border fit highlight-current-row size="small ">
        <el-table-column align="center" prop="id" label="ID" width="65"></el-table-column>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="mini" @click="errorVisible = false">确定</el-button>
      </div>
    </el-dialog>
...
import {
  ...
  updateItem,
  rankItem,
} from "@/api/competitionActivity/jd.js";
...
export default {
  ...
  methods: {
    ...
    submitUser(param) {
      ...
      registerUser(fileForm).then((res) => {
        if (res.code == 0) {
          this.$notify({
            type: "success",
            message: "京东用户导入成功!",
