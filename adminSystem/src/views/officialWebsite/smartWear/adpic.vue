    ...
    <div class="container-edit">
      ...
      <el-form :model="form" label-width="120px">
        <div v-for="(item,index) in list" style="border-bottom: 1px solid #ccc;">
          <el-form-item :label="'智能穿戴产品'+(index+1)">
          </el-form-item>
          ...
          <el-form-item label="产品小类" prop="ifShow">
            <el-radio v-model="item.productDeviceType" label="1">智能手表</el-radio>
            <el-radio v-model="item.productDeviceType" label="2">无线耳机</el-radio>
          </el-form-item>
          ...
          <el-form-item label="产品主图">
            <el-input v-model="item.productPagePic" readonly=""></el-input>
  ...
  export default {
    ...
    methods: {
      ...
      submit(index) {
        ...
        this.list[index].productBelong = '1'; //图片属于首页小图更换
