      ...
      <el-form :model="form" label-width="100px">
        <div v-for="(item,index) in list">
          ...
          <el-form-item label="产品详情页">
            <el-input v-model="item.pictureProductLink" placeholder="跳转链接"></el-input>
          </el-form-item>
          <!-- <el-form-item label="天猫购买链接">
            <el-input v-model="item.pictureTianmaoLink" placeholder="跳转链接"></el-input>
          </el-form-item> -->
          <el-form-item label="文件地址">
            <el-input v-model="item.pictureVideo" ></el-input>
            ...
            <el-upload ref='upload' action="" :http-request="requestFile" :show-file-list="false">
              ...
              <div slot="tip" class="el-upload__tip">图片尺寸1920*838px 比例960:419</br>视频要求：视频比例16：9，最低分辨率要求1280*720</div>
            </el-upload>
          </el-form-item>
          <el-form-item label="">
  ...
  export default {
    ...
    methods: {
      ...
      submit(index) {
        ...
        this.list[index].pictureBelong = '2'; //图片属于首页baneer更换
