      ...
      <el-form :model="form" label-width="100px" >
        <div v-for="(item,index) in list">
          ...
          <el-form-item label="产品名称" >
              <el-input v-model="item.pictureName" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="产品英文" >
              <el-input v-model="item.englishName" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="产品详情链接">
            <el-input v-model="item.pictureProductLink" ></el-input>
          </el-form-item>
          
          <el-form-item label="首页产品图" >
              ...
              <el-upload ref='upload' action="" :http-request="requestFile" :show-file-list="false">
                  ...
                  <div slot="tip" class="el-upload__tip">图片尺寸579*561px 比例193:187</div>
              </el-upload>
          </el-form-item>
          <el-form-item label="">
...
<script>
  ...
  export default {
    ...
    methods: {
      getList() {
          getAllPicture({pictureBelong:'1',pictureType:1}).then(res=>{
             let list = res.data;
             if(list.length<2){
               let lengths = list.length;
               for (let i=0;i<(2-lengths);i++) {
                 list.push({pictureVideo:''});
               }
             }
             this.list = list;
          })
      ...
      submit(index) {
        ...
        this.list[index].pictureBelong = '1';//图片属于首页小图更换
        this.list[index].pictureType = 1;
