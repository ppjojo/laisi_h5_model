        ...
        <div class="container-search">
          <el-form :inline="true" :model="searchForm" ref="search">
            ...
            <el-form-item>
              ...
              <!-- <JsonExcel class="export-excel-wrapper" :data="deviceList" :fields="json_fields" name="其他地区设备报表明细导出.xls" style="display: inline-block;margin-left: 10px;">
              </JsonExcel> -->
            </el-form-item>
          </el-form>
        </div>
...
<script>
  import {
    usaDeviceTotal,
    usasearchDevice,
    usaDeviceVerdion,downloadUsaExcel,
    deviceDayList
   ...
   components: {
    ...
    methods: {
      ...
      searchDevice() {
        ...
        usasearchDevice(para,this.pageInfo).then(res => {
          this.deviceList = res.data.data;
          this.total = res.data.total
        })
      },
      exportExcel(){
        downloadUsaExcel(this.searchForm).then(res=>{
          let fileName = "其他地区设备报表明细导出.xls";
