<template>
    <div class="app-container">
        ...
        <!--新增和编辑界面-->
        <el-dialog :title="dialogTitle+'APP语言'" :visible.sync="dialogVisible" width="50%">
            <el-form :model="form" label-width="100px" :rules="rules" ref="form">
                ...
                <el-form-item label="支持状态">
                    <el-switch v-model="form.isSupport" :active-value="1" :inactive-value="0" inactive-color="#ff4949">
                    </el-switch>
                </el-form-item>
            </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    languageType: [
                        { required: true, message: '请输入语言类型,如：en', trigger: 'blur' },
                    ],
                    isSupport: [
                        { required: true, message: '请选择该语言是否支持', trigger: 'change' }
                    ],
                },
