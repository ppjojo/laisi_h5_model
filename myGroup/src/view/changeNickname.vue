<template>
  <div id="app" class="changeNickname" v-cloak>
    <div class="header">
      <van-nav-bar title="我在小组中的昵称" @click-left="onclickLeft" @click-right="onClickRight" left-arrow safe-area-inset-top fixed>
        <template #left>
...
<script>
import { changeNickname } from "@a/groupIndex";
