<template>
	...
	<div v-if="!recordData.skipRecord&&!recordData.balanceRecord&&!recordData.stepRecord&&!recordData.abrollerRecord&&!recordData.wristBallRecord"
		class="nullDataBox" style="padding-top:2rem;">
