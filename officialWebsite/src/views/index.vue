    ...
    <div class="bannerBox ">
      <swiper :options="swiperOptions_bannner" v-if="banner.length>0">
        <swiper-slide v-for="item in banner" @click-slide="bannerLink">
          <video v-if="item.pictureVideo.indexOf('.mp4')!='-1'" :src="item.pictureVideo" muted="muted" autoplay="" loop="" width="100%"></video>
...
import { getAllPicture } from "@a/picture";
import { getNews } from "@a/index";
var vm = null;
export default {
  filters: {
    formatDate(time) {
